import type { Address, CollateralSymbols, CollIndex } from "@/src/types";
...
export const COLL_SYMBOLS = [
  process.env.NEXT_PUBLIC_COLL_0_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_1_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_2_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_3_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_4_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_5_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_6_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_7_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_8_TOKEN_ID,
  process.env.NEXT_PUBLIC_COLL_9_TOKEN_ID,
].slice(0, COLL_NUM) as CollateralSymbols;
